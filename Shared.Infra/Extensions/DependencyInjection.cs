...
public static class DependencyInjection
{
    ...
    /// <summary>
    /// Registers the generic repository services in the dependency injection container.
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/> to add the services to.</param>
    /// <returns>The updated <see cref="IServiceCollection"/> with generic repository services registered.</returns>
    public static IServiceCollection AddGenericRepos(this IServiceCollection services)
    {
