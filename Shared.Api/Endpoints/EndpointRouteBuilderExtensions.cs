...
public static partial class EndpointRouteBuilderExtensions
{
    ...
    /// </remarks>
    public static RouteGroupBuilder MapGroup(this IEndpointRouteBuilder endpoints, EndpointGroup group)
    {
        return endpoints
    ...
    internal static string PascalToWords(this string value)
    {
        return !string.IsNullOrEmpty(value)
