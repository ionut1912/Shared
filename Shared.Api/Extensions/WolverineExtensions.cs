...
{
    /// <summary>
    ///     Configures Wolverine as the command bus and message broker, integrating RabbitMQ, PostgreSQL persistence, and EF
    ///     Core transactions.
    /// </summary>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Binding <see cref="RabbitMqOptions" /> from the "RabbitMQ" configuration section.</description>
    ///         </item>
    ///         <item>
    ///             <description>Configuring Durable Outbox patterns with PostgreSQL.</description>
    ///         </item>
    ///         <item>
    ///             <description>Automatic provisioning of RabbitMQ exchanges and queues.</description>
    ///         </item>
    ///     </list>
    /// </remarks>
