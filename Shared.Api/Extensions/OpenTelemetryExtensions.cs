...
public static class OpenTelemetryExtensions
{
    ...
    {
        return ResourceBuilder.CreateDefault().AddService(serviceName, null, "1.0.0").AddAttributes(
    ...
    public static WebApplicationBuilder AddOpenTelemetry(this WebApplicationBuilder builder, string lokiEndpoint,
    ...
    public static IServiceCollection AddOpenTelemetryObservability(this IServiceCollection services,
        string otelEndpoint, string serviceName)
    {
        services.AddOpenTelemetry()
            ...
            .WithMetrics(metrics =>
            {
                metrics.AddRuntimeInstrumentation()
                    ...
                    {
                        opts.AddEventSources("Microsoft.AspNetCore.Hosting", "System.Net.Http",
